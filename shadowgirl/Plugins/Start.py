...
from shadowgirl import ASSID, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from shadowgirl import boottime as bot_start_time
from shadowgirl import db
from shadowgirl.Core.PyTgCalls import shadowgirl
from shadowgirl.Database import (add_nonadmin_chat, add_served_chat,
...
from shadowgirl.Decorators.admins import ActualAdminCB
from shadowgirl.Decorators.permission import PermissionCheck
from shadowgirl.Inline import (custommarkup, dashmarkup, setting_markup, setting_markup2,
                          start_pannel, usermarkup, volmarkup)
from shadowgirl.Utilities.ping import get_readable_time
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "LV":
        ...
        volume = 25
        try:
            await shadowgirl.pytgcalls.change_volume_call(c_id, volume)
    ...
    if command == "DIT":
        ...
        await CallbackQuery.answer(
            f"shadowgirl Disk Usage: {diske}%", show_alert=True
        )
