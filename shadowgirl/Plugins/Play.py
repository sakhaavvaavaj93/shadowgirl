...
from shadowgirl import (BOT_USERNAME, DURATION_LIMIT, DURATION_LIMIT_MIN,
                   MUSIC_BOT_NAME, app, db_mem)
from shadowgirl.Core.PyTgCalls.Converter import convert
from shadowgirl.Core.PyTgCalls.Downloader import download
from shadowgirl.Decorators.assistant import AssistantAdd
from shadowgirl.Decorators.checker import checker
from shadowgirl.Decorators.permission import PermissionCheck
from shadowgirl.Inline import (playlist_markup, search_markup, search_markup2,
                          url_markup, url_markup2)
from shadowgirl.Utilities.changers import seconds_to_min, time_to_seconds
from shadowgirl.Utilities.chat import specialfont_to_normal
from shadowgirl.Utilities.stream import start_stream, start_stream_audio
from shadowgirl.Utilities.theme import check_theme
from shadowgirl.Utilities.thumbnails import gen_thumb
from shadowgirl.Utilities.url import get_url
from shadowgirl.Utilities.youtube import (get_yt_info_id, get_yt_info_query,
...
@app.on_callback_query(filters.regex(pattern=r"shadowgirl"))
