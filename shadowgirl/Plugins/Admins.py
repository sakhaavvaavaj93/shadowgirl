...
from shadowgirl.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat)
from shadowgirl.Decorators.admins import AdminRightsCheck
from shadowgirl.Decorators.checker import checker, checkerCB
from shadowgirl.Inline import audio_markup, primary_markup
...
async def admins(_, message: Message):
    ...
    if message.command[0][1] == "e":
        ...
        await shadowgirl.pytgcalls.resume_stream(message.chat.id)
        await message.reply_text(
    ...
    if message.command[0][1] == "t" or message.command[0][1] == "n":
        ...
        await shadowgirl.pytgcalls.leave_group_call(message.chat.id)
        await message.reply_text(
