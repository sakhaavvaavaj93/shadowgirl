...
from shadowgirl import BOT_USERNAME, db_mem
from shadowgirl.Core.PyTgCalls import Queues, shadowgirl
from shadowgirl.Database import (add_active_chat, is_active_chat, music_off,
                            music_on)
from shadowgirl.Inline import (audio_markup, audio_markup2, primary_markup,
                          secondary_markup)
